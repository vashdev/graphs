...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		// sum of getneighbours , get inneighbour 
		//use map testmap.dat
		 
		List<Integer> inNeighbourlist = new ArrayList<Integer>();
		List<Integer> outNeighbourlist = new ArrayList<Integer>();
		...
		for (int i =0; i< getNumVertices() ;i++){
			int vdegree=0;
			outNeighbourlist=getNeighbors(i);
			inNeighbourlist=getInNeighbors(i);			
			vdegree=outNeighbourlist.size()+inNeighbourlist.size();
			degreelist.add(vdegree);
		}
